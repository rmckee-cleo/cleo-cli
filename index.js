...
switch (platform) {
  ...
  case 'win32':
    switch (arch) {
      case 'x64':
        localFileExisted = existsSync(
          join(__dirname, 'cleo-cli.win32-x64-msvc.node')
        )
        try {
          if (localFileExisted) {
      ...
      case 'ia32':
        localFileExisted = existsSync(
          join(__dirname, 'cleo-cli.win32-ia32-msvc.node')
        )
        try {
          if (localFileExisted) {
      ...
      case 'arm64':
        localFileExisted = existsSync(
          join(__dirname, 'cleo-cli.win32-arm64-msvc.node')
        )
        try {
          if (localFileExisted) {
    ...
    break
  case 'darwin':
    localFileExisted = existsSync(join(__dirname, 'cleo-cli.darwin-universal.node'))
    try {
      if (localFileExisted) {
        nativeBinding = require('./cleo-cli.darwin-universal.node')
      } else {
        nativeBinding = require('@rmckee-cleo/cleo-cli-darwin-universal')
      }
      break
    } catch {}
    switch (arch) {
      ...
      case 'arm64':
        localFileExisted = existsSync(
          join(__dirname, 'cleo-cli.darwin-arm64.node')
        )
        try {
          if (localFileExisted) {
  ...
  case 'linux':
    switch (arch) {
      case 'x64':
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, 'cleo-cli.linux-x64-musl.node')
          )
          try {
            if (localFileExisted) {
          ...
          localFileExisted = existsSync(
            join(__dirname, 'cleo-cli.linux-x64-gnu.node')
          )
          try {
            if (localFileExisted) {
      ...
      case 'arm64':
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, 'cleo-cli.linux-arm64-musl.node')
          )
          try {
            if (localFileExisted) {
          ...
          localFileExisted = existsSync(
            join(__dirname, 'cleo-cli.linux-arm64-gnu.node')
          )
          try {
            if (localFileExisted) {
      ...
      case 'arm':
        localFileExisted = existsSync(
          join(__dirname, 'cleo-cli.linux-arm-gnueabihf.node')
        )
        try {
          if (localFileExisted) {
